...
export default function WorkingWithObjectsAsynchronously() {
  ...
  return (
    <div id="wd-asynchronous-objects">
      ...
      <h4>Assignment</h4>
      <Form.Control defaultValue={assignment.title} className="mb-2"
        onChange={(e) => setAssignment({ ...assignment, title: e.target.value }) } />
      <Form.Control rows={3} defaultValue={assignment.description} className="mb-2"
        onChange={(e) => setAssignment({ ...assignment, description: e.target.value }) }/>
      <Form.Control type="date" className="mb-2" defaultValue={assignment.due}
