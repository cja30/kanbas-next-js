...
export default function PathParameters() {
  ...
  return (
    <div>
      ...
      <Form.Control className="mb-2" id="wd-path-parameter-a" type="number" defaultValue={a}
             onChange={(e) => setA(e.target.value)}/>
      <Form.Control className="mb-2" id="wd-path-parameter-b" type="number" defaultValue={b}
